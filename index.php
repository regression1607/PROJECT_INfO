    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--info">
            ...
            <ul class="footer-nav__list">
              <li class="footer-nav__item">
                <a href="#" class="footer-nav__link">thetech</a>
              </li>
              <li class="footer-nav__item">
                <a href="#" class="footer-nav__link">Basic Project</a>
              </li>
              <li class="footer-nav__item">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">ekanshrajput1607@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Project INfO&trade;
          </div>
